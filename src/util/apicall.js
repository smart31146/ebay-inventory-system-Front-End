...
const endpoints = {
    ...
    //Migrate product into order list
    ...
    get_filter_orders: (formatted_Date) => api.get(`product/get_filter_orders/?formatted_Date=${formatted_Date}`),
    ...
    get_custom_deleted_products: () => api.get('product/get_custom_deleted_products/'),
    // Get Shipping Fee
